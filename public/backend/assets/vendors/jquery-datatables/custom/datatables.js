 ...
 *   https://datatables.net/download/#bs5/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/fc-4.1.0/fh-3.2.3/r-2.3.0
 *
 * Included libraries:
 *   DataTables 1.12.1, Buttons 2.2.3, Column visibility 2.2.3, FixedColumns 4.1.0, FixedHeader 3.2.3, Responsive 2.3.0
 */
...
(function (factory) {
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build: "bs5/dt-1.12.1/b-2.2.3/b-colvis-2.2.3/fc-4.1.0/fh-3.2.3/r-2.3.0",
    ...
    var FixedColumns = /** @class */ (function () {
        ...
        FixedColumns.prototype._addStyles = function () {
            ...
            if (this.s.dt.settings()[0].oScroll.sY) {
                var scroll_1 = $(this.s.dt.table().node()).closest(
        ...
        _detailsDisplay: function (row, update) {
            ...
            if (details && details.type !== false) {
                ...
                var res = details.display(row, update, function () {
                    return renderer(dt, row[0], that._detailsObj(row[0]));
                });
