        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('backend/assets/compiled/img/error-404.svg') }}"
                        alt="Not Found">
                    <h1 class="error-title">404 - NOT FOUND</h1>
                    <p class='fs-5 text-gray-600'>Mohon Maaf, Halaman Tidak Ditemukan</p>
                    <a href="{{ route('dashboard') }}" class="btn btn-lg btn-outline-primary mt-3">Kembali</a>
                </div>
            </div>
        </div>
